...
- Testing infrastructure or rigor mentioned (Vitest, Jest, Playwright, Cypress, pytest, coverage targets, CI gates)
...
| "Playwright E2E with 80% coverage" | ✅ Clear | Testing stack + target set → testingRigor = full inferred |
| "(no testing strategy mentioned)" | ⚠️ Ambiguous | Important gap — resolvable in qa-strategy if not resolved in grill |
